...
\begin{frame}
	...
	NE extraction with spaCy.
	\vfill

	Applied wikification technique (how many NEs had Wikipedia articles)
	\vfill

	spaCy had trouble correctly identifying NEs suggesting standard NER tools not ideal with texts regarding illegal activities
	\vfill
