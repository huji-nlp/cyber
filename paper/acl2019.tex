...
\begin{table*}[]
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{@{}lllllllllllll@{}}
            ...
            all onion        &           & 0.23             & 0.25             & 0.6  & 0.61        & 0.61        & 0.33    & 0.39           & 0.41           & 0.35  & 0.41         & 0.42         \\
            all onion\_half1 & 0.23      &                  & 0.43             & 0.6  & 0.62        & 0.62        & 0.37    & 0.33           & 0.5            & 0.4   & 0.36         & 0.52         \\
            all onion\_half2 & 0.25      & 0.43             &                  & 0.61 & 0.62        & 0.62        & 0.39    & 0.5            & 0.35           & 0.39  & 0.51         & 0.35         \\
            ebay             & 0.6       & 0.6              & 0.61             &      & 0.23        & 0.25        & 0.59    & 0.6            & 0.6            & 0.66  & 0.67         & 0.67         \\
            ebay\_half1      & 0.61      & 0.62             & 0.62             & 0.23 &             & 0.43        & 0.6     & 0.61           & 0.61           & 0.67  & 0.67         & 0.68         \\
            ebay\_half2      & 0.61      & 0.62             & 0.62             & 0.25 & 0.43        &             & 0.6     & 0.61           & 0.61           & 0.67  & 0.68         & 0.68         \\
            illegal          & 0.33      & 0.37             & 0.39             & 0.59 & 0.6         & 0.6         &         & 0.23           & 0.27           & 0.61  & 0.62         & 0.62         \\
            illegal\_half1   & 0.39      & 0.33             & 0.5              & 0.6  & 0.61        & 0.61        & 0.23    &                & 0.45           & 0.62  & 0.63         & 0.62         \\
            illegal\_half2   & 0.41      & 0.5              & 0.35             & 0.6  & 0.61        & 0.61        & 0.27    & 0.45           &                & 0.62  & 0.63         & 0.63         \\
            legal            & 0.35      & 0.4              & 0.39             & 0.66 & 0.67        & 0.67        & 0.61    & 0.62           & 0.62           &       & 0.26         & 0.26         \\
...
\end{table*}
    ...
    %the domains we deal with is a different domain in terms of word use, whether all Onion language should be considered a single domain, and is there a potential in learning differences between onion sites. 
    ...
    %We can therefore think of the three as three different domains. 
...
%We note that an exact that ratio of false positives is not something that is easily quantifiable, and therefore this is only a qualitative observation. 
%That being said, it is our impression that the informal language used in our datasets makes it harder
...
% In particular, slang terms for drugs as well as abbreviated drug terms, for example "kush" or "GBL", were being falsely picked up. 
...
% informal language on the internet, especially language dealing in
% illicit activities. 
% >>>>>>> 68831c30bf8b1fba57d739cf9147b51f3793fcd3
...
To investigate the illegality detection across different domains, we replicate the classification experiments on the ``forums'' category that was separated in DUTA-10K, as in the case ``drugs'',  into legal and illegal sub-categories. 
...
and noisy. We use the same cleaning process as described in \ref{datasets}.

\subsection{Results}

\paragraph{Legal vs. illegal forums.}

Results when training and testing on forums data are much worse,
