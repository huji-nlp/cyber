...
distinguishing between the domains. Another goal of the classification task is to confirm our findings about the domains difference, as different domains should be separable.
