...
\subsection{Differences in Named Entities}\label{sec:ner}
    ...
    entity mentions from all the corpora \footnote{We used all named entity types (and not only “product”) to gain a greater perspective of the differences between the domains regarding named entities. For example, even the prevalence of named entities that are not directly drug related could be used to differentiate between domains.}. 
