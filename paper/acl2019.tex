...
\begin{abstract}
  The non-indexed parts of the Internet (the Darknet)
	%\daniel{I think it should be Darknet (in this capitalization) and always with ``the'' preceding it}
...
\\
\multicolumn{7}{l}{\bf Legal vs. Illegal Forums, Trained on Drugs} \\
\hline
