...
\newcommand{\ApplyGradient}[1]{%
  \pgfmathsetmacro{\PercentColor}{(#1-0)/10}%
...
\begin{itemize}
  \item Dropping all content words (dropcontent).
  \item Dropping all function words (dropfunc).
  \item Replacing all content words with their universal part-of-speech (poscontent).
  \item Replacing all function words with their universal part-of-speech (posfunc).
...
eBay vs. legal drugs \\
Model & \multicolumn{1}{c}{\bf full} & \multicolumn{1}{c}{\bf dropcontent} & \multicolumn{1}{c}{\bf dropfunc} & \multicolumn{1}{c}{\bf poscontent} & \multicolumn{1}{c}{\bf posfunc} & \multicolumn{1}{c}{\bf pos}\\
Naive Bayes & 91.4 & 57.8 & 90.5 & 56.9 & 92.2 & 46.6\\
SVM & 63.8 & 64.7 & 63.8 & 68.1 & 63.8 & 75\\
BoE (sum) & 66.4 & 56 & 63.8 & 50.9 & 76.7 & \\
BoE (average) & 75 & 55.2 & 59.5 & 50 & 75 & \\
seq2vec & 73.3 &  & 65.5 & 65.5 & 75 & \\
ELMo+attention & 82.8 &  & 85.3 & 62.1 & 82.8 & 62.9\\
\end{tabular}
