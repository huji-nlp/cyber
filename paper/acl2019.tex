...
\section{Introduction}
  ...
  We find a number of distinguishing features. First, we confirm the results of \citet{Avarikioti18}, that legal and illegal
  pages\oa{is it pages or sentences?} can be distinguished based on the identity of the content words (bag of words model) 
