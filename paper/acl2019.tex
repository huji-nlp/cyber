...
\section{Introduction}
  ...
  By experimenting on a different domain in Tor (user-generated content), we show that the legal/illegal distinction generalizes across domains.\footnote{Our
  data and code (preprocessing, analysis and classification)
  are included in the supplementary material, and
...
domains, so as to make them distinuishable in terms of their distribution of grammatical categories.
% =======
...
The much lower results obtained by the models where content words are dropped (drop cont.) are converted to POS tags (pos cont.),
namely less than 70\% as opposed to 89.7\% in the full setting, suggest that some of these properties are lexical.
...
\section{Discussion} \label{sec:discussion}
  ...
  %   may also be a result of the pretrained word embeddings needing to adapt
...
\section{Conclusion} \label{sec:conclusion}
  ...
  We conclude from this investigation that Onion pages provide an attractive testbed for studying distinguishing
    factors between the text of legal illegal webpages, as they present challenges to off-the-shelf NLP tools,
